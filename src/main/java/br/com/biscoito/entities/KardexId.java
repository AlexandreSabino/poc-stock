...
public class KardexId implements Serializable {
    ...
    @PrimaryKeyColumn(name = "dateOfMovement", ordinal = 0, type = PrimaryKeyType.PARTITIONED)
    ...
    public KardexId(final InventoryId inventoryId) {
        this.sku =  inventoryId.getSku();
        this.warehouseCode = inventoryId.getWarehouseCode();
        this.sellerId = inventoryId.getSellerId();
        this.productOrigin = inventoryId.getProductOrigin();
